...
_Generated: 2026-08-14T19:19:02.599650+00:00_
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;0.174</td>
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;0.150</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;1.504</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;4.223</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;1.978</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;5.557</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;1.551</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;1.126</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;1.740</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;20.618</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;32.332</td>
</tr>
<tr>
<td style="text-align:left">Summarize the contribution of 'Automated Literature Revie...</td>
<td style="text-align:right">—</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;30.308</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;30.627</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;33.314</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;22.745</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;31.298</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;32.910</td>
</tr>
<tr>
<td style="text-align:left">What is the paper 'MUST-RAG: MUSical Text Question Answer...</td>
<td style="text-align:right">—</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;23.034</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;19.991</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;27.543</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;21.841</td>
...
<td style="background-color:#ffeb9c;text-align:right;white-space:nowrap">🟡&nbsp;30.112</td>
...
<td style="background-color:#c6efce;text-align:right;white-space:nowrap">🟢&nbsp;33.242</td>
</tr>
</tbody>
</table>
...
- **baseline:** 8.24s (CPU) → 1.50s (GPU) = **5.5×** faster time-to-response
- **baseline_gguf:** 10.05s (CPU) → 7.67s (GPU) = **1.3×** faster time-to-response
- **fine_tuned:** 9.36s (CPU) → 1.08s (GPU) = **8.7×** faster time-to-response
- **fine_tuned_with_rag:** 28.73s (CPU) → 2.36s (GPU) = **12.2×** faster time-to-response
...
**CPU → GPU speedup (time_to_response):**
- **baseline:** 31.56s (CPU) → 4.22s (GPU) = **7.5×** faster time-to-response
- **baseline_gguf:** 8.85s (CPU) → 9.54s (GPU) = **0.9×** faster time-to-response
- **fine_tuned:** 38.79s (CPU) → 3.84s (GPU) = **10.1×** faster time-to-response
- **fine_tuned_with_rag:** 56.33s (CPU) → 4.17s (GPU) = **13.5×** faster time-to-response
...
**CPU → GPU speedup (time_to_response):**
- **baseline:** 9.70s (CPU) → 1.98s (GPU) = **4.9×** faster time-to-response
- **baseline_gguf:** 8.28s (CPU) → 7.72s (GPU) = **1.1×** faster time-to-response
- **fine_tuned:** 14.06s (CPU) → 1.51s (GPU) = **9.3×** faster time-to-response
- **fine_tuned_with_rag:** 74.18s (CPU) → 3.74s (GPU) = **19.8×** faster time-to-response
...
**CPU → GPU speedup (time_to_response):**
- **baseline:** 29.34s (CPU) → 5.56s (GPU) = **5.3×** faster time-to-response
- **baseline_gguf:** 11.95s (CPU) → 9.89s (GPU) = **1.2×** faster time-to-response
- **fine_tuned:** 37.33s (CPU) → 3.91s (GPU) = **9.6×** faster time-to-response
- **fine_tuned_with_rag:** 60.55s (CPU) → 3.59s (GPU) = **16.9×** faster time-to-response
...
**CPU → GPU speedup (time_to_response):**
- **baseline:** 8.88s (CPU) → 1.55s (GPU) = **5.7×** faster time-to-response
- **baseline_gguf:** 7.81s (CPU) → 7.92s (GPU) = **1.0×** faster time-to-response
- **fine_tuned:** 9.07s (CPU) → 1.13s (GPU) = **8.1×** faster time-to-response
- **fine_tuned_with_rag:** 16.45s (CPU) → 0.65s (GPU) = **25.2×** faster time-to-response
...
**CPU → GPU speedup (time_to_response):**
- **baseline:** 8.25s (CPU) → 1.74s (GPU) = **4.7×** faster time-to-response
- **baseline_gguf:** 8.38s (CPU) → 7.53s (GPU) = **1.1×** faster time-to-response
- **fine_tuned:** 10.74s (CPU) → 1.11s (GPU) = **9.7×** faster time-to-response
- **fine_tuned_with_rag:** 33.09s (CPU) → 3.98s (GPU) = **8.3×** faster time-to-response
